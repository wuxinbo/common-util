...
/*     */{
	...
	/*     */{
		...
		/*     */
		/* 186 */String szSrc = "99999999";
		/* 187 */System.out.println("加密前的字符�?" + szSrc + "  --   "
				+ szSrc.length());
		/* 188 */String ew = getEncryptStr(szSrc);
		/* 189 */System.out.println("加密后的字符�?" + ew + "  --   "
				+ ew.length());
		/* 190 */String ds = getDecryptStr("98AE79CAE1F4D235");
		/* 191 */System.out.println("加密后的字符�?" + ds + "  --   "
				+ ew.length());
		/*     */}
	/*     */
}
...
/*
 * Location: C:\Users\wuxinbo\Desktop\JDBCAuth\ Qualified Name:
 * com.sinosoft.sa.cognos.auth.TripleDES JD-Core Version: 0.6.0
 */